...
Original file is located at
    https://colab.research.google.com/drive/1-aeHCR34PJMD5HBipZTHCUSKfsaRXzUP
"""
...
def lonja():
        ...
        for n in range(1,13):
          ...
          url=(f"https://lalonjapropiedadraiz.com/inmuebles/Venta/clases_Apartamento_Casa/precio_0_999999999999/{n}")
          r=requests.get(url)
          ...
          if r.status_code==200:
            ...
            print(f" Pagina {n} no encontrada ")
